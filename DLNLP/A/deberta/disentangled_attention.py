...
class DisentangledSelfAttention(torch.nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, return_att=False, query_states=None, relative_pos=None, rel_embeddings=None):
        ...
        query_layer = query_layer + self.transpose_for_scores(self.q_bias.unsqueeze(0).unsqueeze(0))
        value_layer = value_layer + self.transpose_for_scores(self.v_bias.unsqueeze(0).unsqueeze(0))
